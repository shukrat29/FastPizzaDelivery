...
Button.propTypes = {
  ...
  disabled: PropTypes.bool, // Boolean to indicate if the button is disabled
  to: PropTypes.string, // Optional string for navigation links
  type: PropTypes.oneOf(["primary", "small", "round", "secondary"]).isRequired, // Restrict to specific button types
  onClick: PropTypes.func, // Optional function for click handlers
};

Button.defaultProps = {
  disabled: false, // Default value for disabled prop
  to: null, // Default value for to prop
  onClick: null, // Default value for onClick prop
};
